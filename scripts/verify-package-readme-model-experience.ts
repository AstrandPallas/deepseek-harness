...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/goal/goal-governor': { kind: 'indirect', reason: 'The governor routes pause/resume mutations through ctx.goals; the goal service owns the model-visible goal/change context message.' },
